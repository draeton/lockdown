...
<link rel="stylesheet" href="http://draeton.github.com/lockdown/lockdown/build/css/lockdown-0.0.37-min.css">
...
The latest release, **0.0.37, is [available here](http://draeton.github.com/lockdown/lockdown/dist/lockdown-0.0.37.zip).**
...
<script>
Modernizr.load([
    "/lockdown/lockdown/build/js/lockdown-0.0.37-min.js",
    {
        test: Modernizr.canvas,
