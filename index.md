...
<link rel="stylesheet" href="http://draeton.github.com/lockdown/lockdown/build/css/lockdown-0.0.33-min.css">
...
The latest release, **0.0.33, is [available here](http://draeton.github.com/lockdown/lockdown/dist/lockdown-0.0.33.zip).**
...
<script>
Modernizr.load([
    "/lockdown/lockdown/build/js/lockdown-0.0.33-min.js",
    {
        test: Modernizr.canvas,
