...
<link rel="stylesheet" href="css/lockdown-0.0.11-min.css">
...
<script src="js/lockdown-0.0.11-min.js"></script>
{% endhighlight %}
...
The latest release, **0.0.11, is [available here](dist/lockdown-0.0.11.zip).**
